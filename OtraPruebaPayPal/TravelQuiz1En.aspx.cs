...
{
    public partial class TravelQuiz1En : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("TravelQuizEn.aspx");
        }
        ...
        protected void BtnVerificar_Click(object sender, EventArgs e)
        {
            ...
            if (resultado <= 2)
            {
                LblCorrectas.Text = "Try again, your result was: " + resultado + "/4 :(";
            }

            if (resultado == 3)
            {
                LblCorrectas.Text = "Almost! Your result was: " + resultado + "/4";
            }
            if (resultado == 4)
            {
