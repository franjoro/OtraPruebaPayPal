<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TravelQuiz10.aspx.cs" Inherits="OtraPruebaPayPal.TravelQuiz10" %>
                ...
                <div class="container">
                    ...
                    <section id="p0">
                        <asp:Label ID="Label2" runat="server" Font-Size="X-Large">
                            1.	¿Cuántos km mide San Vicente?
                        </asp:Label>
                        <label>
                            <asp:RadioButton ID="RB1correcto" runat="server" Text="1184 km²" GroupName="grupo1" />
                        </label>
                        <label>
                            <asp:RadioButton ID="RadioButton3" runat="server" Text="984 km²" GroupName="grupo1" />
                        </label>
                        <label>
                            <asp:RadioButton ID="RadioButton4" runat="server" Text="1994 km²" GroupName="grupo1" />
                        </label>
                    </section>

                    <section id="p1">
                        <asp:Label ID="Label3" runat="server" Font-Size="X-Large">
                            2.	¿Cuántos municipios tiene San Vicente?
                        </asp:Label>
                        <label>
                            <asp:RadioButton ID="RadioButton5" runat="server" Text="10 municipios" GroupName="grupo2" />
                        </label>
                        <label>
                            <asp:RadioButton ID="RB2correcto" runat="server" Text="13 municipios" GroupName="grupo2" />
                        </label>
                        <label>
                            <asp:RadioButton ID="RadioButton7" runat="server" Text="23 municipios" GroupName="grupo2" />
                        </label>
                    </section>

                    <section id="p2">
                        <asp:Label ID="Label4" runat="server" Font-Size="X-Large">
                            3.	¿Cuál es el volcán más alto de San Vicente?
                        </asp:Label>
                        <label>
                            <asp:RadioButton ID="RadioButton8" runat="server" Text="Volcan de Conchagua" GroupName="grupo3" />
                        </label>
                        <label>
                            <asp:RadioButton ID="RadioButton9" runat="server" Text="El Pital" GroupName="grupo3" />
                        </label>
                        <label>
                            <asp:RadioButton ID="RB3correcto" runat="server" Text="El volcán Chinchontepec" GroupName="grupo3" />
                        </label>
                    </section>

                    <section id="p3">
                        <asp:Label ID="Label5" runat="server" Font-Size="X-Large">
                            4.	¿En que año fue fundado San Vicente?
                        </asp:Label>
                        <label>
                            <asp:RadioButton ID="RadioButton11" runat="server" Text="1865" GroupName="grupo4" />
                        </label>
                        <label>
                            <asp:RadioButton ID="RB4correcto" runat="server" Text="1635" GroupName="grupo4" />
                        </label>
                        <label>
                            <asp:RadioButton ID="RadioButton13" runat="server" Text="1202" GroupName="grupo4" />
                        </label>
                    </section>
