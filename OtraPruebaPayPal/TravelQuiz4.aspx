<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TravelQuiz4.aspx.cs" Inherits="OtraPruebaPayPal.TravelQuiz4" %>
                ...
                <div class="container">
                    <section id="p0">
                        <asp:Label ID="Label2" runat="server" Font-Size="X-Large">
                            1.	¿Cuántas personas habitan en Cuscatlán?
                        </asp:Label>
                        <label>
                    ...
                    <section id="p1">
                        <asp:Label ID="Label3" runat="server" Font-Size="X-Large">
                            2.	¿Cómo es el clima en Cuscatlán?
                        </asp:Label>
                        <label>
                    ...
                    <section id="p2">
                        <asp:Label ID="Label4" runat="server" Font-Size="X-Large">
                            3.	¿Cuál es el municipio más grande de Cuscatlán?
                        </asp:Label>
                        <label>
                    ...
                    <section id="p3">
                        <asp:Label ID="Label5" runat="server" Font-Size="X-Large">
                            4.	¿Cuántos municipios tiene Cuscatlán?
                        </asp:Label>
                        <label>
