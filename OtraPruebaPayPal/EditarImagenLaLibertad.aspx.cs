...
{
    public partial class EditarImagenLaLibertad : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("La Libertad.aspx");
        }
        ...
        {
            DataTable myTable = conexiones.ListarImagenesLaLibertad();
        ...
        protected void cargar_registro(int id)
        {
            try
            {
                string[] respuesta = conexiones.SeleccionarRegistroImagenLaLibertad(id);
        ...
        protected void btnEditar_Click(object sender, EventArgs e)
        {
            ...
            if (PhotoFile.HasFile) //Verifica si se ha subido un archivo
            {
                ...
                int guardado = conexiones.ActualizarImagenLaLibertad(id, texto, foto);
        ...
        protected void btnEliminar_Click(object sender, EventArgs e)
        {
            ...
            if (isNumber)
            {
                int eliminado = conexiones.EliminarRegistroLaLibertad(id);
                if (eliminado == 1)
                {
