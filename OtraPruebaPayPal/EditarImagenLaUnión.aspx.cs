...
{
    public partial class EditarImagenLaUnión : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("La Unión.aspx");
        }
        ...
        {
            DataTable myTable = conexiones.ListarImagenesLaUnion();
        ...
        protected void cargar_registro(int id)
        {
            try
            {
                string[] respuesta = conexiones.SeleccionarRegistroImagenLaUnion(id);
        ...
        protected void btnEditar_Click(object sender, EventArgs e)
        {
            ...
            if (PhotoFile.HasFile) //Verifica si se ha subido un archivo
            {
                ...
                int guardado = conexiones.ActualizarImagenLaUnion(id, texto, foto);
        ...
        protected void btnEliminar_Click(object sender, EventArgs e)
        {
            ...
            if (isNumber)
            {
                int eliminado = conexiones.EliminarRegistroLaUnion(id);
                if (eliminado == 1)
                {
