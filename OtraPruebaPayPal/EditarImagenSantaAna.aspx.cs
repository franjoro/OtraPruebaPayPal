...
{
    public partial class EditarImagenSantaAna : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("Santa Ana.aspx");
        }
        ...
        {
            DataTable myTable = conexiones.ListarImagenesSantaAna();
        ...
        protected void cargar_registro(int id)
        {
            try
            {
                string[] respuesta = conexiones.SeleccionarRegistroImagenSantaAna(id);
        ...
        protected void btnEditar_Click(object sender, EventArgs e)
        {
            ...
            if (PhotoFile.HasFile) //Verifica si se ha subido un archivo
            {
                ...
                int guardado = conexiones.ActualizarImagenSantaAna(id, texto, foto);
        ...
        protected void btnEliminar_Click(object sender, EventArgs e)
        {
            ...
            if (isNumber)
            {
                int eliminado = conexiones.EliminarRegistroSantaAna(id);
                if (eliminado == 1)
                {
