<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AgregarImagenUsulután.aspx.cs" Inherits="OtraPruebaPayPal.AgregarImagenUsulután" %>
...
<body>
    <form id="form1" runat="server">
        <nav class="navbar navbar-expand-sm bg-dark navbar-dark fixed-top">
            <a class="navbar-brand" href="#">Usulután</a>
