<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PlanViaje.aspx.cs" Inherits="OtraPruebaPayPal.PlanViaje1" %>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ms-auto">
                        <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded" href="default.aspx">Regresar</a></li>
                    ...
                    <div class="izquierda">
                        <div class="planCont plan-1">
                            <div class="priceAndSignupCont">
                                ...
                                <asp:Button runat="server" ID="Compra1" class="custom-btn btn-5" OnClick="Compra1_Click" Text="Comprar" />
                                <%--<button id="compra1" class="custom-btn btn-5" onclick="incrementar1()"><span>Comprar</span></button>--%>
                            </div>
                            <ul class="specsCont">
                                <li class="propValue">5:
					
                            <span class="propName">Vehiculos</span>
                                </li>
                                <li class="propValue">5: 
					
                            <span class="propName">Departamentos</span>
                                </li>
                                <li class="propValue">Si:
					
                            <span class="propName">Estadia</span>
                                </li>
                                <li class="propValue">Si:
					
                            <span class="propName">Comida</span>
                                </li>
                            </ul>
                        </div>
                        <div class="planCont plan-3">
                            <div class="priceAndSignupCont">
                                ...
                                <span class="priceDuration">/viaje</span>
                                <asp:Button runat="server" ID="Compra2" class="custom-btn btn-5" OnClick="Compra2_Click" Text="Comprar" />
                    ...
                    <div class="derecha">
                        <div class="planCont plan-2">
                            <div class="priceAndSignupCont">
                                ...
                                <span class="priceDuration">/viaje</span>
                                <asp:Button runat="server" ID="Compra3" class="custom-btn btn-5" OnClick="Compra3_Click" Text="Comprar" />
                        ...
                        <div class="planCont plan-4">
                            <div class="priceAndSignupCont">
                                ...
                                <span class="priceDuration">/viaje</span>
                                <asp:Button runat="server" ID="Compra4" class="custom-btn btn-5" OnClick="Compra4_Click" Text="Comprar" />
