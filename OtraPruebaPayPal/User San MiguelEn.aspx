<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="User San MiguelEn.aspx.cs" Inherits="OtraPruebaPayPal.User_San_Miguel" %>
...
<body>
        ...
        <form id="form1" runat="server">
            <a class="navbar-brand" href="User Mapa.aspx">San Miguel</a>
        ...
        <header class="masthead bg-primary text-white text-center" style="background-color:#FFA07A!important">
            <div class="container d-flex align-items-center flex-column">
                ...
                <!-- Masthead Heading-->
                <h1 class="masthead-heading text-uppercase mb-0">San Miguel</h1>
        </header>
        <section class="page-section bg-primary text-white mb-0" id="about" style="background-color:#2c3e50!important">
            <div class="container">
                <!-- About Section Heading-->
                <h2 class="page-section-heading text-center text-uppercase text-white">History of San Miguel</h2>
                <!-- Icon Divider-->
                ...
                <div class="row">
                    <div class="col-lg-4 ms-auto">
                        <p class="lead">The territory was originally populated by Lenca groups. After the foundation of the town of San Salvador in 1525, the Spanish entrusted Captain Luis de Moscoso with the foundation of San Miguel de la Frontera, which took place in 1530.
                        <br />
                        In 1865, during the Government of Francisco Dueñas, it was decided that the department should reduce its size and the departments of La Unión and Usulutan be created at the expense of the territory.</p>
                    </div>
                    <div class="col-lg-4 me-auto">
                        <p class="lead">Among the notable political figures from this department are Captain General Gerardo Barrios, and Captain General Miguel Santín del Castillo, who in two presidential periods made important contributions such as the introduction of normal education and public schools; and the promotion of the industrialized cultivation of coffee.</p>
                    </div>
                </div>
            </div>
        </section>
