...
{
    public partial class La_Paz : System.Web.UI.Page
    {
        ...
        {
            string[] datos = conexiones.ObtenerImagenesLaPaz();
        ...
        {
            Response.Redirect("AgregarImagenLaPaz.aspx");
        }

        protected void btnEditarImagen_Click(object sender, EventArgs e)
        {
            Response.Redirect("EditarImagenLaPaz.aspx");
        }
    }
}