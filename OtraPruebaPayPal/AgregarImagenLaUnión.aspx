<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AgregarImagenLaUnión.aspx.cs" Inherits="OtraPruebaPayPal.AgregarImagenLaUnión" %>
...
<body>
    <form id="form1" runat="server">
        <nav class="navbar navbar-expand-sm bg-dark navbar-dark fixed-top">
            <a class="navbar-brand" href="#">La Unión</a>
