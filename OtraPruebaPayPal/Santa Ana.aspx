<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Santa Ana.aspx.cs" Inherits="OtraPruebaPayPal.Santa_Ana" %>
...
<body>
        ...
        <form id="form1" runat="server">
            <a class="navbar-brand" href="Mapa.aspx">Santa Ana</a>
...
<%--                <asp:Button ID="btncerrar" class="btn btn-outline-warning my-2 my-sm-0" type="submit" runat="server" Text="Cerrar sesion" OnClick="btncerrar_Click" />--%>
        ...
        <header class="masthead bg-primary text-white text-center" style="background-color:#FFA07A!important">
            <div class="container d-flex align-items-center flex-column">
                ...
                <!-- Masthead Heading-->
                <h1 class="masthead-heading text-uppercase mb-0">Santa Ana</h1>
        </header>
        <section class="page-section bg-primary text-white mb-0" id="about" style="background-color:#2c3e50!important">
            <div class="container">
                <!-- About Section Heading-->
                <h2 class="page-section-heading text-center text-uppercase text-white">Historia de Santa Ana</h2>
                <!-- Icon Divider-->
                ...
                <div class="row">
                    <div class="col-lg-4 ms-auto">
                        <p class="lead">En la denominada "época de oro del café" en El Salvador, Santa Ana fue la ciudad más próspera del país, debido a que muchos de los empresarios que lo cultivaban vivían en dicha localidad; además, se encontraban importantes plantas beneficiadoras que preparaban el café para su venta.
                        <br />
                        La Hacienda El Molino, cuyo propietario era el colombiano Rafael Álvarez, era la principal hacienda y planta procesadora de café, debido a su fama mundial y a su modernismo tecnológico en ese entonces.</p>
                    </div>
                    <div class="col-lg-4 me-auto">Durante la guerra civil de El Salvador (1980 - 1992), el municipio de Santa Ana también fue afectado por el conflicto armado, lo cual provocó la emigración de varios pobladores a la ciudad.
                        <p class="lead">
                        <br />
                        En la posguerra, Santa Ana y todo El Salvador empezaron a afrontar el problema del aumento en los índices de delincuencia, principalmente por la existencia de "maras" o pandillas, generadas principalmente por la deportación de inmigrantes indocumentados desde los Estados Unidos. Tal flagelo ha sido afrontado con programas gubernamentales y ordenanzas emitidas por el concejo municipal.</p>
                    </div>
                </div>
            </div>
        </section>
