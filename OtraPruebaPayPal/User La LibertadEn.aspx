<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="User La LibertadEn.aspx.cs" Inherits="OtraPruebaPayPal.User_La_Libertad" %>
...
<body>
        ...
        <form id="form1" runat="server">
            <a class="navbar-brand" href="User Mapa.aspx">La Libertad</a>
        ...
        <section class="page-section bg-primary text-white mb-0" id="about" style="background-color:#2c3e50!important">
            <div class="container">
                ...
                <h2 class="page-section-heading text-center text-uppercase text-white">History of La Libertad</h2>
                <!-- Icon Divider-->
                ...
                <div class="row">
                    <div class="col-lg-4 ms-auto">
                        <p class="lead">The department was created in 1865 by a legislative decree that was published in the official government newspaper "El Constitucional" Volume 1,
                        <br />
                        Number 70, on February 9, 1865.</p>
                    </div>
                    <div class="col-lg-4 me-auto">
                        <p class="lead">According to the statistics of the department of La Libertad made by Governor José López on May 23, 1865,
                        <br />
                        the department had a population of 16,759 people.</p>
                    </div>
                </div>
            </div>
        </section>
