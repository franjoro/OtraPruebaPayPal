<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TravelQuiz2.aspx.cs" Inherits="OtraPruebaPayPal.TravelQuiz2" %>
                ...
                <div class="container">
                    <section id="p0">
                        <asp:Label ID="Label2" runat="server" Font-Size="X-Large">
                            1.	¿Cuánto mide la región de Santa Ana?
                        </asp:Label>
                        <label>
                    ...
                    <section id="p1">
                        <asp:Label ID="Label3" runat="server" Font-Size="X-Large">
                            2.	¿Cuánta población tiene Santa Ana?
                        </asp:Label>
                        <label>
                    ...
                    <section id="p2">
                        <asp:Label ID="Label4" runat="server" Font-Size="X-Large">
                            3.	¿Cómo es el clima normalmente en Santa Ana?
                        </asp:Label>
                        <label>
                    ...
                    <section id="p3">
                        <asp:Label ID="Label5" runat="server" Font-Size="X-Large">
                            4.	¿El escudo de Santa Ana tiene franjas celestes y blancas?
                        </asp:Label>
                        <label>
