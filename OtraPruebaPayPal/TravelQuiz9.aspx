<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TravelQuiz9.aspx.cs" Inherits="OtraPruebaPayPal.TravelQuiz9" %>
                ...
                <div class="container">
                    ...
                    <section id="p0">
                        <asp:Label ID="Label2" runat="server" Font-Size="X-Large">
                            1.	¿Cuál es la cabecera departamental de Cabañas?
                        </asp:Label>
                        <label>
                            <asp:RadioButton ID="RB1correcto" runat="server" Text="Sensuntepeque" GroupName="grupo1" />
                        </label>
                        <label>
                            <asp:RadioButton ID="RadioButton3" runat="server" Text="Texistepeque" GroupName="grupo1" />
                        </label>
                        <label>
                            <asp:RadioButton ID="RadioButton4" runat="server" Text="Zacatecoluca" GroupName="grupo1" />
                        </label>
                    </section>

                    <section id="p1">
                        <asp:Label ID="Label3" runat="server" Font-Size="X-Large">
                            2.	¿Cuál es el municipio más importante de Cabañas?
                        </asp:Label>
                        <label>
                            <asp:RadioButton ID="RadioButton5" runat="server" Text="Dolores" GroupName="grupo2" />
                        </label>
                        <label>
                            <asp:RadioButton ID="RB2correcto" runat="server" Text="Ilobasco" GroupName="grupo2" />
                        </label>
                        <label>
                            <asp:RadioButton ID="RadioButton7" runat="server" Text="Cinquera" GroupName="grupo2" />
                        </label>
                    </section>

                    <section id="p2">
                        <asp:Label ID="Label4" runat="server" Font-Size="X-Large">
                            3.	¿Cuándo fue fundado Cabañas?
                        </asp:Label>
                        <label>
                            <asp:RadioButton ID="RadioButton8" runat="server" Text="07/12/1979" GroupName="grupo3" />
                        </label>
                        <label>
                            <asp:RadioButton ID="RadioButton9" runat="server" Text="02/02/2001" GroupName="grupo3" />
                        </label>
                        <label>
                            <asp:RadioButton ID="RB3correcto" runat="server" Text="10/02/1873" GroupName="grupo3" />
                        </label>
                    </section>

                    <section id="p3">
                        <asp:Label ID="Label5" runat="server" Font-Size="X-Large">
                            4.	¿Cuál es la población de cabañas?
                        </asp:Label>
                        <label>
                            <asp:RadioButton ID="RadioButton11" runat="server" Text="948,585 hab" GroupName="grupo4" />
                        </label>
                        <label>
                            <asp:RadioButton ID="RB4correcto" runat="server" Text="215,400 hab" GroupName="grupo4" />
                        </label>
                        <label>
                            <asp:RadioButton ID="RadioButton13" runat="server" Text="68,128 hab" GroupName="grupo4" />
                        </label>
                    </section>
