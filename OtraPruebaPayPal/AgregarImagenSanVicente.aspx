<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AgregarImagenSanVicente.aspx.cs" Inherits="OtraPruebaPayPal.AgregarImagenSanVicente" %>
...
<body>
    <form id="form1" runat="server">
        <nav class="navbar navbar-expand-sm bg-dark navbar-dark fixed-top">
            <a class="navbar-brand" href="#">Sam Vicente</a>
