<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AgregarImagenCuscatlán.aspx.cs" Inherits="OtraPruebaPayPal.AgregarImagenCuscatlán" %>
...
<body>
    <form id="form1" runat="server">
        <nav class="navbar navbar-expand-sm bg-dark navbar-dark fixed-top">
            <a class="navbar-brand" href="#">Cuscatlán</a>
