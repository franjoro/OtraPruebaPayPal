<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Sonsonate.aspx.cs" Inherits="OtraPruebaPayPal.Sonsonate" %>
...
<body>
        ...
        <form id="form1" runat="server">
            <a class="navbar-brand" href="Mapa.aspx">Sonsonate</a>
...
<%--                <asp:Button ID="btncerrar" class="btn btn-outline-warning my-2 my-sm-0" type="submit" runat="server" Text="Cerrar sesion" OnClick="btncerrar_Click" />--%>
        ...
        <section class="page-section bg-primary text-white mb-0" id="about" style="background-color:#2c3e50!important">
            <div class="container">
                ...
                <h2 class="page-section-heading text-center text-uppercase text-white">Historia de Sonsonate</h2>
                <!-- Icon Divider-->
