<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SeleccionDepartamento.aspx.cs" Inherits="OtraPruebaPayPal.SeleccionDepartamento" %>
    ...
    <form id="form1" runat="server">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ms-auto">
                        <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded" href="Mapa.aspx">Regresar</a></li>
                    </ul>
                </div>
            </div>
        </nav>
        <header>
            <div class="container" style="margin-top:8rem">
                <h1 class="text-center">Seleccione un departamento</h1>
                <hr />
            </div>
        </header>
        <!-- START SECTION STORE -->
                        ...
                        <div class="col-12 col-md-6">
                            <div class="item shadow mb-4">
                                ...
                                <div class="item-details">
                                    ...
                                    <asp:Button runat="server" ID="Ahuachapan" class="item-button btn btn-primary addToCart" OnClick="Ahuachapan_Click" Text="SELECCIONAR" />
                                </div>
                            </div>
                        </div>
                        <div class="col-12 col-md-6">
                            <div class="item shadow mb-4">
                                ...
                                <div class="item-details">
                                    ...
                                    <asp:Button runat="server" ID="Cabañas" class="item-button btn btn-primary addToCart" OnClick="Cabañas_Click" Text="SELECCIONAR" />
                        ...
                        <div class="col-12 col-md-6">
                            <div class="item shadow mb-4">
                                ...
                                <div class="item-details">
                                    ...
                                    <asp:Button runat="server" ID="Chalatenango" class="item-button btn btn-primary addToCart" OnClick="Chalatenango_Click" Text="SELECCIONAR" />
                        ...
                        <div class="col-12 col-md-6">
                            <div class="item shadow mb-4">
                                ...
                                <div class="item-details">
                                    ...
                                    <asp:Button runat="server" ID="Cuscatlan" class="item-button btn btn-primary addToCart" OnClick="Cuscatlan_Click" Text="SELECCIONAR" />
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-12 col-md-6">
                            <div class="item shadow mb-4">
                                ...
                                <div class="item-details">
                                    ...
                                    <asp:Button runat="server" ID="LaLibertad" class="item-button btn btn-primary addToCart" OnClick="LaLibertad_Click" Text="SELECCIONAR" />
                                </div>
                            </div>
                        </div>
                        <div class="col-12 col-md-6">
                            <div class="item shadow mb-4">
                                ...
                                <div class="item-details">
                                    ...
                                    <asp:Button runat="server" ID="Morazan" class="item-button btn btn-primary addToCart" OnClick="Morazan_Click" Text="SELECCIONAR" />
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-12 col-md-6">
                            <div class="item shadow mb-4">
                                ...
                                <div class="item-details">
                                    ...
                                    <asp:Button runat="server" ID="LaPaz" class="item-button btn btn-primary addToCart" OnClick="LaPaz_Click" Text="SELECCIONAR" />
                                </div>
                            </div>
                        </div>
                        <div class="col-12 col-md-6">
                            <div class="item shadow mb-4">
                                ...
                                <div class="item-details">
                                    ...
                                    <asp:Button runat="server" ID="SantaAna" class="item-button btn btn-primary addToCart" OnClick="SantaAna_Click" Text="SELECCIONAR" />
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-12 col-md-6">
                            <div class="item shadow mb-4">
                                ...
                                <div class="item-details">
                                    ...
                                    <asp:Button runat="server" ID="SanMiguel" class="item-button btn btn-primary addToCart" OnClick="SanMiguel_Click" Text="SELECCIONAR" />
                                </div>
                            </div>
                        </div>
                        <div class="col-12 col-md-6">
                            <div class="item shadow mb-4">
                                ...
                                <div class="item-details">
                                    ...
                                    <asp:Button runat="server" ID="SanSalvador" class="item-button btn btn-primary addToCart" OnClick="SanSalvador_Click" Text="SELECCIONAR" />
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-12 col-md-6">
                            <div class="item shadow mb-4">
                                ...
                                <div class="item-details">
                                    ...
                                    <asp:Button runat="server" ID="SanVicente" class="item-button btn btn-primary addToCart" OnClick="SanVicente_Click" Text="SELECCIONAR" />
                                </div>
                            </div>
                        </div>
                        <div class="col-12 col-md-6">
                            <div class="item shadow mb-4">
                                ...
                                <div class="item-details">
                                    ...
                                    <asp:Button runat="server" ID="Sonsonate" class="item-button btn btn-primary addToCart" OnClick="Sonsonate_Click" Text="SELECCIONAR" />
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-12 col-md-6">
                            <div class="item shadow mb-4">
                                ...
                                <div class="item-details">
                                    ...
                                    <asp:Button runat="server" ID="LaUnión" class="item-button btn btn-primary addToCart" OnClick="LaUnión_Click" Text="SELECCIONAR" />
                                </div>
                            </div>
                        </div>
                        <div class="col-12 col-md-6">
                            <div class="item shadow mb-4">
                                ...
                                <div class="item-details">
                                    ...
                                    <asp:Button runat="server" ID="Usulutan" class="item-button btn btn-primary addToCart" OnClick="Usulutan_Click" Text="SELECCIONAR" />
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <section class="shopping-cart">
            <div class="container">
                <h1 class="text-center">EL PLAN QUE ELIGIO</h1>
                <hr />
                <div class="row">
                    <div class="col-6">
                ...
                <div id="plan1" class="row shoppingCartItem" style="display: none" runat="server">
                    <div class="col-6">
                        <div class="shopping-cart-item d-flex align-items-center h-100 border-bottom pb-2 pt-3">
                            <h6 class="shopping-cart-item-title shoppingCartItemTitle text-truncate ml-3 mb-0">Plan Estandar</h6>
                        </div>
                    </div>
                    <div class="col-2">
                ...
                <div id="plan2" class="row shoppingCartItem" style="display: none" runat="server">
                    <div class="col-6">
                        <div class="shopping-cart-item d-flex align-items-center h-100 border-bottom pb-2 pt-3">
                            <h6 class="shopping-cart-item-title shoppingCartItemTitle text-truncate ml-3 mb-0">Plan de Pareja</h6>
                        </div>
                    </div>
                    <div class="col-2">
                        <div class="shopping-cart-price d-flex align-items-center h-100 border-bottom pb-2 pt-3">
                ...
                <div id="plan3" class="row shoppingCartItem" style="display: none" runat="server">
                    <div class="col-6">
                        <div class="shopping-cart-item d-flex align-items-center h-100 border-bottom pb-2 pt-3">
                            <h6 class="shopping-cart-item-title shoppingCartItemTitle text-truncate ml-3 mb-0">Plan Familiar</h6>
                        </div>
                    </div>
                    <div class="col-2">
                        <div class="shopping-cart-price d-flex align-items-center h-100 border-bottom pb-2 pt-3">
                ...
                <div id="plan4" class="row shoppingCartItem" style="display: none" runat="server">
                    <div class="col-6">
                        <div class="shopping-cart-item d-flex align-items-center h-100 border-bottom pb-2 pt-3">
                            <h6 class="shopping-cart-item-title shoppingCartItemTitle text-truncate ml-3 mb-0">Plan Grupal</h6>
                        </div>
                    </div>
                    <div class="col-2">
                        <div class="shopping-cart-price d-flex align-items-center h-100 border-bottom pb-2 pt-3">
                ...
                <%-- ****************Departamentos**************************** --%>
                <h1 class="text-center"  runat="server" id="control">SELECCIONE LOS DEPARTAMENTOS QUE VISITARA:</h1>
                <hr />
                <div class="row">
                    <div class="col-6">
                        <div class="shopping-cart-header">
                    ...
                    <div class="col-2">
                        <div class="shopping-cart-header">
                            <h6 class="text-truncate">N° Departamento</h6>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="shopping-cart-header">
                ...
                <div id="especial1" class="row shoppingCartItem" style="display: none" runat="server">
                    ...
                    <div class="col-4">
                        <div
                            ...
                            <input id="AhuachapanInput" class="shopping-cart-quantity-input shoppingCartItemQuantity" type="number" value="1" min="1" max="2" runat="server" />
                        ...
                        <div class="shopping-cart-total d-flex align-items-center">
                            ...
                            <div class="toast ml-auto bg-info" role="alert" aria-live="assertive" aria-atomic="true"
                                ...
                                <div class="toast-header">
                                    <span>✅</span>
                                    <strong class="mr-auto ml-1 text-secondary">Departamento selecionado</strong>
                            ...
                            <asp:Button runat="server" class="btn btn-success ml-auto comprarButton" Text="Ir al Transporte" ID="btnTransporte" OnClick="btnTransporte_Click" />
                        </div>
                    </div>
                </div>
                <!-- END TOTAL -->
