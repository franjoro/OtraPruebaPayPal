<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TravelQuiz5.aspx.cs" Inherits="OtraPruebaPayPal.TravelQuiz5" %>
                ...
                <div class="container">
                    ...
                    <section id="p0">
                        <asp:Label ID="Label2" runat="server" Font-Size="X-Large">
                            1.	¿Cuál es la cabecera departamental de La Libertad?
                        </asp:Label>
                        <label>
                    ...
                    <section id="p1">
                        <asp:Label ID="Label3" runat="server" Font-Size="X-Large">
                           2.	¿Cuál es la playa más importante de La Libertad?
                        </asp:Label>
                        <label>
                    ...
                    <section id="p2">
                        <asp:Label ID="Label4" runat="server" Font-Size="X-Large">
                            3.	¿Cuántos municipios tiene La Libertad?
                        </asp:Label>
                    ...
                    <section id="p3">
                        <asp:Label ID="Label5" runat="server" Font-Size="X-Large">
                            4.	¿El pueblo de Ataco está en La Libertad?
                        </asp:Label>
                        <label>
