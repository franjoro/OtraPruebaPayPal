...
{
    public partial class EditarImagenUsulután : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("Usulután.aspx");
        }
        ...
        {
            DataTable myTable = conexiones.ListarImagenesUsulutan();
        ...
        protected void cargar_registro(int id)
        {
            try
            {
                string[] respuesta = conexiones.SeleccionarRegistroImagenUsulutan(id);
        ...
        protected void btnEditar_Click(object sender, EventArgs e)
        {
            ...
            if (PhotoFile.HasFile) //Verifica si se ha subido un archivo
            {
                ...
                int guardado = conexiones.ActualizarImagenUsulutan(id, texto, foto);
        ...
        protected void btnEliminar_Click(object sender, EventArgs e)
        {
            ...
            if (isNumber)
            {
                int eliminado = conexiones.EliminarRegistroUsulutan(id);
                if (eliminado == 1)
                {
