...
{
    public partial class Morazán : System.Web.UI.Page
    {
        ...
        {
            string[] datos = conexiones.ObtenerImagenesMorazan();
        ...
        {
            Response.Redirect("AgregarImagenMorazán.aspx");
        }

        protected void btnEditarImagen_Click(object sender, EventArgs e)
        {
            Response.Redirect("EditarImagenMorazán.aspx");
        }
    }
}