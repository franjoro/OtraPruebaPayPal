<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="La Libertad.aspx.cs" Inherits="OtraPruebaPayPal.La_Libertad" %>
...
<body>
        ...
        <form id="form1" runat="server">
            <a class="navbar-brand" href="Mapa.aspx">La Libertad</a>
...
<%--                <asp:Button ID="btncerrar" class="btn btn-outline-warning my-2 my-sm-0" type="submit" runat="server" Text="Cerrar sesion" OnClick="btncerrar_Click" />--%>
        ...
        <header class="masthead bg-primary text-white text-center" style="background-color:#FFA07A!important">
            <div class="container d-flex align-items-center flex-column">
                ...
                <!-- Masthead Heading-->
                <h1 class="masthead-heading text-uppercase mb-0">La Libertad</h1>
        </header>
        <section class="page-section bg-primary text-white mb-0" id="about" style="background-color:#2c3e50!important">
            <div class="container">
                <!-- About Section Heading-->
                <h2 class="page-section-heading text-center text-uppercase text-white">Historia de La Libertad</h2>
                <!-- Icon Divider-->
                ...
                <div class="row">
                    <div class="col-lg-4 ms-auto">
                        <p class="lead">El departamento fue creado en 1865 por un decreto legislativo que fue publicado en el periódico oficial del gobierno "El Constitucional" Tomo 1,
                        <br />
                        Número 70, en el 9 de febrero de 1865.</p>
                    </div>
                    <div class="col-lg-4 me-auto">
                        <p class="lead">De acuerdo con la estadística del departamento de La Libertad hecha por el gobernador José López en el 23 de mayo de 1865, 
                        <br />
                        el departamento tenía una población de 16 759 personas.</p>
                    </div>
                </div>
            </div>
        </section>
