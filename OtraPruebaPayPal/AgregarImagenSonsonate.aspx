<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AgregarImagenSonsonate.aspx.cs" Inherits="OtraPruebaPayPal.AgregarImagenSonsonate" %>
...
<body>
    <form id="form1" runat="server">
        <nav class="navbar navbar-expand-sm bg-dark navbar-dark fixed-top">
            <a class="navbar-brand" href="#">Sonsonate</a>
