<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="User MorazánEn.aspx.cs" Inherits="OtraPruebaPayPal.User_Morazán" %>
...
<body>
        ...
        <form id="form1" runat="server">
            <a class="navbar-brand" href="User Mapa.aspx">Morazán</a>
        ...
        <section class="page-section bg-primary text-white mb-0" id="about" style="background-color:#2c3e50!important">
            <div class="container">
                ...
                <h2 class="page-section-heading text-center text-uppercase text-white">History of Morazán</h2>
                <!-- Icon Divider-->
                ...
                <div class="row">
                    <div class="col-lg-4 ms-auto">
                        <p class="lead">In the department there are still traces of the presence of the Paleoindians —the first settlers of El Salvador— in the Cueva del Espíritu Santo, an archaeological site with cave paintings in the vicinity of the municipality of Corinto.
                        <br />
                        In the time before the Spanish conquest, Morazán was inhabited by indigenous Lencas.</p>
                    </div>
                    <div class="col-lg-4 me-auto">
                        <p class="lead">In colonial times, the territory was subdivided into the districts of Gotera and Osicala. It was created with the name of Gotera Department on July 14, 1875, by order of President Santiago González.
                        <br />
                        By decree of the Legislative Assembly it received its current name on March 14, 1887, in homage to the Central American unionist General Francisco Morazán.</p>
                    </div>
                </div>
            </div>
        </section>
