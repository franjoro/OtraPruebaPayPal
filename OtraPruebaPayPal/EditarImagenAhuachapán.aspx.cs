...
{
    public partial class EditarImagenAhuachapán : System.Web.UI.Page
    {
        ...
        {
            DataTable myTable = conexiones.ListarImagenesAhuachapán();
        ...
        protected void cargar_registro(int id)
        {
            try
            {
                string[] respuesta = conexiones.SeleccionarRegistroImagenAhuachapán(id);
        ...
        protected void btnEditar_Click(object sender, EventArgs e)
        {
            ...
            if (PhotoFile.HasFile) //Verifica si se ha subido un archivo
            {
                ...
                int guardado = conexiones.ActualizarImagenAhuachapán(id, texto, foto);
        ...
        protected void btnEliminar_Click(object sender, EventArgs e)
        {
            ...
            if (isNumber)
            {
                int eliminado = conexiones.EliminarRegistroAhuachapán(id);
                if (eliminado == 1)
                {
