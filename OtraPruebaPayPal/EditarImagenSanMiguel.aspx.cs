...
{
    public partial class EditarImagenSanMiguel : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("San Miguel.aspx");
        }
        ...
        {
            DataTable myTable = conexiones.ListarImagenesSanMiguel();
        ...
        protected void cargar_registro(int id)
        {
            try
            {
                string[] respuesta = conexiones.SeleccionarRegistroImagenSanMiguel(id);
        ...
        protected void btnEditar_Click(object sender, EventArgs e)
        {
            ...
            if (PhotoFile.HasFile) //Verifica si se ha subido un archivo
            {
                ...
                int guardado = conexiones.ActualizarImagenSanMiguel(id, texto, foto);
        ...
        protected void btnEliminar_Click(object sender, EventArgs e)
        {
            ...
            if (isNumber)
            {
                int eliminado = conexiones.EliminarRegistroSanMiguel(id);
                if (eliminado == 1)
                {
