<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="User La PazEn.aspx.cs" Inherits="OtraPruebaPayPal.User_La_Paz" %>
...
<body>
        ...
        <form id="form1" runat="server">
            <a class="navbar-brand" href="User Mapa.aspx">La Paz</a>
        ...
        <section class="page-section bg-primary text-white mb-0" id="about" style="background-color:#2c3e50!important">
            <div class="container">
                ...
                <h2 class="page-section-heading text-center text-uppercase text-white">History of La Paz</h2>
                <!-- Icon Divider-->
                ...
                <div class="row">
                    <div class="col-lg-4 ms-auto">
                        <p class="lead">According to the archaeological remains found in the area between the Lempa and Jiboa rivers, the territory of the department was populated by Mayan communities until the end of the 11th century. At that time, the first invading wave of Mesoamerican Nahua peoples took place.
                        <br />
                        After the Toltec occupation, in whose settlement process they tended to mix with the local tribes, the Nonualcos, belonging to the Nahua group of Kuskatan, settled down four centuries later. </p>
                    </div>
                    <div class="col-lg-4 me-auto">
                        <p class="lead">The foundation or repopulation of urban centers such as Cuyultitán, Analco, Tecoluca, Santiago, San Pedro, San Juan Nonualco, Santa María Ostuma and Zacatecoluca is due to them. This last population was, in colonial times, one of the four most important pre-Columbian cities in the country and, as such, was designated party head in 1786.
                        <br />
                        In 1814, the city of Zacatecoluca starred in one of the most significant episodes of the Salvadoran independence movement, when the nonualcos took up arms, took over the town and forced their mayor to proclaim emancipation.</p>
                    </div>
                </div>
            </div>
        </section>
