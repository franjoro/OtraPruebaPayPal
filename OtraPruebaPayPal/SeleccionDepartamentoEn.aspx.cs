...
{
    public partial class SeleccionDepartamentoEn : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("TransporteEn.aspx");
        }
        ...
        private void AhuachapanInput_TextChanged(object sender, EventArgs e)
        {
            if (System.Text.RegularExpressions.Regex.IsMatch(AhuachapanInput.Value, " ^ [1-2]"))
            {
                AhuachapanInput.Value = "";
            }
        }
