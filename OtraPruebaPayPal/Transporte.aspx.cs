...
namespace OtraPruebaPayPal
{
    public partial class Transporte : System.Web.UI.Page
    {
        ...
        protected void btnPayPal_Click(object sender, EventArgs e)
        {
            ...
            {
                alerta.Text = "<script>Swal.fire('Algo salio mal', '´Por favor inicia sesión', 'error') </script>";
            }
            else
            {
                ...
                redirectUrls.cancel_url = "http://localhost:44321/Transporte.aspx";
                redirectUrls.return_url = "https://localhost:44321/default.aspx";
