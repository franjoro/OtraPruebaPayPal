<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="register.aspx.cs" Inherits="OtraPruebaPayPal.register" %>
...
<body>
    <form id="register" runat="server" data-sb-form-api-token="API_TOKEN">
        <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
            <div class="container">
                <a class="navbar-brand" href="#page-top">Registro</a>
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ms-auto">
                        <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded" href="default.aspx">Página Principal</a></li>
                        <li class="nav-item mx-0 mx-lg-"><a class="nav-link py-3 px-0 px-lg-3 rounded" href="Login.aspx">Login</a></li>
                    </ul>
                </div>
            </div>
        </nav>
