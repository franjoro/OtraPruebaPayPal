<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AgregarImagenSanMiguel.aspx.cs" Inherits="OtraPruebaPayPal.AgregarImagenSanMiguel" %>
...
<body>
    <form id="form1" runat="server">
        <nav class="navbar navbar-expand-sm bg-dark navbar-dark fixed-top">
            <a class="navbar-brand" href="#">San Miguel</a>
