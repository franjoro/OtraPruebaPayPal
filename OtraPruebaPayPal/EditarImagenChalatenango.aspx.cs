...
{
    public partial class EditarImagenChalatenango : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("Chalatenango.aspx");
        }
        ...
        {
            DataTable myTable = conexiones.ListarImagenesChalatenango();
        ...
        protected void cargar_registro(int id)
        {
            try
            {
                string[] respuesta = conexiones.SeleccionarRegistroImagenChalatenango(id);
        ...
        protected void btnEditar_Click(object sender, EventArgs e)
        {
            ...
            if (PhotoFile.HasFile) //Verifica si se ha subido un archivo
            {
                ...
                int guardado = conexiones.ActualizarImagenChalatenango(id, texto, foto);
        ...
        protected void btnEliminar_Click(object sender, EventArgs e)
        {
            ...
            if (isNumber)
            {
                int eliminado = conexiones.EliminarRegistroChalatenango(id);
                if (eliminado == 1)
                {
