<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="User San VicenteEn.aspx.cs" Inherits="OtraPruebaPayPal.User_San_Vicente" %>
...
<body>
        ...
        <form id="form1" runat="server">
            <a class="navbar-brand" href="User Mapa.aspx">San Vicente</a>
        ...
        <header class="masthead bg-primary text-white text-center" style="background-color:#FFA07A!important">
            <div class="container d-flex align-items-center flex-column">
                ...
                <!-- Masthead Heading-->
                <h1 class="masthead-heading text-uppercase mb-0">San Vicente</h1>
        </header>
        <section class="page-section bg-primary text-white mb-0" id="about" style="background-color:#2c3e50!important">
            <div class="container">
                <!-- About Section Heading-->
                <h2 class="page-section-heading text-center text-uppercase text-white">History of San Vicente</h2>
                <!-- Icon Divider-->
                ...
                <div class="row">
                    <div class="col-lg-4 ms-auto">
                        <p class="lead">Archaeological remains and vestiges of the culture of the Nahuas of Kuskatan and of the Nonualcos during the Postclassic period have been found in the department, in municipalities such as San Cayetano Istepeque, Verapaz, Tepetitán and Tecoluca. The department was created during the administration of the first head of state and optimate of the Central American Independence Juan Manuel Rodríguez, on June 12, 1824 and functioned as the capital of El Salvador from 1834 to 1840.</p>
                    </div>
                    <div class="col-lg-4 me-auto">
                        <p class="lead">Among the artistic monuments we must point out the church around 1760, in front of the square of the same name, La Torre from December to 31 of the same month in honor of Saint Vincent of Austria and Lorenzana.</p>
                    </div>
                </div>
            </div>
        </section>
