<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Administradores.aspx.cs" Inherits="OtraPruebaPayPal.Administradores" %>
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ms-auto">
                        <li class="nav-item mx-0 mx-lg-1 down"><a class="nav-link py-3 px-0 px-lg-3 rounded down">Perfil</a>
                            <ul class="subul">
                                <li class="nav-item mx-0 mx-lg-1 subdown"><a class="nav-link px-0 px-lg-3 rounded"><asp:Button runat="server" ID="btnAcceder" Text="Acceder" class="nav-link px-0 rounded nada" OnClick="btnAcceder_Click"/></a></li>
                                <li class="nav-item mx-0 mx-lg-1 subdown"><a class="nav-link px-0 px-lg-3 rounded"><asp:Button runat="server" ID="btnRegistro" Text="Registrarse" class="nav-link px-0 rounded nada" OnClick="btnRegistro_Click"/></a></li>
                            </ul>
                        </li>
                        <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded" href="Mapa.aspx">Mapa</a></li>
                        <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded" href="Estadisticas.aspx">Estadisticas</a></li>
                    </ul>
                </div>
            </div>
        </nav>
        ...
        <script>
            ...
            */
            (function () { // DON'T EDIT BELOW THIS LINE
                ...
                s.src = 'https://turismore.disqus.com/embed.js';
                s.setAttribute('data-timestamp', +new Date());
                (d.head || d.body).appendChild(s);
            })();
        </script>
        <noscript>Please enable JavaScript to view the <a href="https://disqus.com/?ref_noscript">comments powered by Disqus.</a></noscript>
        <script id="dsq-count-scr" src="//turismore.disqus.com/count.js" async=""></script>
        <!-- Footer-->
