...
{
    public partial class EditarImagenLaPaz : System.Web.UI.Page
    {
        ...
        {
            DataTable myTable = conexiones.ListarImagenesLaPaz();
        ...
        protected void cargar_registro(int id)
        {
            try
            {
                string[] respuesta = conexiones.SeleccionarRegistroImagenLaPaz(id);
        ...
        protected void btnEditar_Click(object sender, EventArgs e)
        {
            ...
            if (PhotoFile.HasFile) //Verifica si se ha subido un archivo
            {
                ...
                int guardado = conexiones.ActualizarImagenLaPaz(id, texto, foto);
        ...
        protected void btnEliminar_Click(object sender, EventArgs e)
        {
            ...
            if (isNumber)
            {
                int eliminado = conexiones.EliminarRegistroLaPaz(id);
                if (eliminado == 1)
                {
