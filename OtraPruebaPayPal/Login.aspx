<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="OtraPruebaPayPal.Login" %>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ms-auto">
                        <li class="nav-item mx-0 mx-lg-0"><a class="nav-link py-3 px-0 px-lg-3 rounded" href="default.aspx">Página Principal</a></li>
                        <li class="nav-item mx-0 mx-lg-"><a class="nav-link py-3 px-0 px-lg-3 rounded" href="register.aspx">Registro</a></li>
                    </ul>
                </div>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-7   col-xl-6">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-7 col-xl-6">
                        <div class="form-floating mb-3">
                            <asp:HyperLink ID="Forgot" runat="server" NavigateUrl="~/ForgotPsswrd.aspx">Olvidaste tu contraseña? Presiona aquí</asp:HyperLink>
                        </div>
