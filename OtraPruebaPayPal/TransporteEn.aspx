<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TransporteEn.aspx.cs" Inherits="OtraPruebaPayPal.TransporteEn1" %>
...
<%--    <form id="form1" runat="server">--%>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ms-auto">
                        <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded" href="Mapa.aspx">Return</a></li>
                    </ul>
                </div>
            </div>
        </nav>
    <header>
        <div class="container">
            <h1 class="text-center">Car Rental - Turismore</h1>
            <hr/>
        </div>
    </header>
    <!-- START SECTION STORE -->
        ...
        <div class="container">
            <div class="items">
                <div class="row">
                    <div class="col-12 col-md-6">
                        <div class="item shadow mb-4">
                            <h3 class="item-title">Bike</h3>
                            <img class="item-image" src="./img/bicicleta.jpg"/>

                            <div class="item-details">
                                <h4 class="item-price">$5.00</h4>
                                <button class="item-button btn btn-primary addToCart">RESERVE</button>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-md-6">
                        <div class="item shadow mb-4">
                            <h3 class="item-title">ATV</h3>
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-6">
                        <div class="item shadow mb-4">
                            <h3 class="item-title">Canoe</h3>

                            <img class="item-image" src="./img/canoa.png"/>

                            <div class="item-details">
                                <h4 class="item-price">$20.00</h4>
                                <button class="item-button btn btn-primary addToCart">RESERVE</button>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-12 col-md-6">
                        <div class="item shadow mb-4">
                            <h3 class="item-title">Motorboat</h3>
    ...
    <section class="shopping-cart">
        <div class="container">
            <h1 class="text-center">RENTED VEHICLE CART</h1>
            <hr/>
            <div class="row">
                <div class="col-6">
                    ...
                    <div class="shopping-cart-total d-flex align-items-center">
                        ...
                        <div class="toast ml-auto bg-info" role="alert" aria-live="assertive" aria-atomic="true"
                            ...
                            <div class="toast-header">
                                <span>✅</span>
                                <strong class="mr-auto ml-1 text-secondary">Item in cart</strong>
                        ...
                        <form runat="server">
                            <asp:Button runat="server" class="btn btn-success ml-auto comprarButton" Text="Transference" ID="btntransferencia" OnClick="btntransferencia_Click"/>
