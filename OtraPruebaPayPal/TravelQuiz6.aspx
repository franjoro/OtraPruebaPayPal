<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TravelQuiz6.aspx.cs" Inherits="OtraPruebaPayPal.TravelQuiz6" %>
                ...
                <div class="container">
                    ...
                    <section id="p0">
                        <asp:Label ID="Label2" runat="server" Font-Size="X-Large">
                            1.	¿Cuál es la comida típica de Sonsonate?
                        </asp:Label>
                        <label>
                    ...
                    <section id="p1">
                        <asp:Label ID="Label3" runat="server" Font-Size="X-Large">
                            2.	¿Cuál es el lugar más visitado de Sonsonate?
                        </asp:Label>
                        <label>
                    ...
                    <section id="p2">
                        <asp:Label ID="Label4" runat="server" Font-Size="X-Large">
                           3.	¿Cuál es la cabecera departamental de Sonsonate?
                        </asp:Label>
                        <label>
                    ...
                    <section id="p3">
                        <asp:Label ID="Label5" runat="server" Font-Size="X-Large">
                           4.	¿Cuál es la población de Sonsonate?
                        </asp:Label>
                        <label>
