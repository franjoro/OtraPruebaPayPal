...
{
    public partial class EditarImagenCuscatlán : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("Cuscatlán.aspx");
        }
        ...
        {
            DataTable myTable = conexiones.ListarImagenesCuscatlan();
        ...
        protected void cargar_registro(int id)
        {
            try
            {
                string[] respuesta = conexiones.SeleccionarRegistroImagenCuscatlan(id);
        ...
        protected void btnEditar_Click(object sender, EventArgs e)
        {
            ...
            if (PhotoFile.HasFile) //Verifica si se ha subido un archivo
            {
                ...
                int guardado = conexiones.ActualizarImagenCuscatlan(id, texto, foto);
        ...
        protected void btnEliminar_Click(object sender, EventArgs e)
        {
            ...
            if (isNumber)
            {
                int eliminado = conexiones.EliminarRegistroCuscatlan(id);
                if (eliminado == 1)
                {
