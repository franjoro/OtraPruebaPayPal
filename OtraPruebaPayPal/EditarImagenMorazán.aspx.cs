...
{
    public partial class EditarImagenMorazán : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("Morazán.aspx");
        }
        ...
        {
            DataTable myTable = conexiones.ListarImagenesMorazan();
        ...
        protected void cargar_registro(int id)
        {
            try
            {
                string[] respuesta = conexiones.SeleccionarRegistroImagenMorazan(id);
        ...
        protected void btnEditar_Click(object sender, EventArgs e)
        {
            ...
            if (PhotoFile.HasFile) //Verifica si se ha subido un archivo
            {
                ...
                int guardado = conexiones.ActualizarImagenMorazan(id, texto, foto);
        ...
        protected void btnEliminar_Click(object sender, EventArgs e)
        {
            ...
            if (isNumber)
            {
                int eliminado = conexiones.EliminarRegistroMorazan(id);
                if (eliminado == 1)
                {
