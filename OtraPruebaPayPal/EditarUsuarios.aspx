<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditarUsuarios.aspx.cs" Inherits="OtraPruebaPayPal.EditarUsuarios" %>
                    ...
                    <div class="col-sm-6 col-sm-offset-3 myform-cont">
                        ...
                        <div class="myform-bottom">
                            <form role="form" action="" method="post" class="">
                                ...
                                <asp:Button runat="server" Text="Seleccionar" CssClass="mybtn" OnClick="btnSeleccionar" Width="109px"></asp:Button>
                                <asp:Button runat="server" Text="Editar" CssClass="mybtn" OnClick="btnEditar"></asp:Button>
