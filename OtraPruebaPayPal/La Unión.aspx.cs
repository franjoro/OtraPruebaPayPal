...
{
    public partial class La_Unión : System.Web.UI.Page
    {
        ...
        {
            string[] datos = conexiones.ObtenerImagenesLaUnion();
        ...
        {
            Response.Redirect("AgregarImagenLaUnión.aspx");
        }

        protected void btnEditarImagen_Click(object sender, EventArgs e)
        {
            Response.Redirect("EditarImagenLaUnión.aspx");
        }
    }
}