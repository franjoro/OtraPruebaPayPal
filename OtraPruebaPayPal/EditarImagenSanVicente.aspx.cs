...
{
    public partial class EditarImagenSanVicente : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("San Vicente.aspx");
        }
        ...
        {
            DataTable myTable = conexiones.ListarImagenesSanVicente();
        ...
        protected void cargar_registro(int id)
        {
            try
            {
                string[] respuesta = conexiones.SeleccionarRegistroImagenSanVicente(id);
        ...
        protected void btnEditar_Click(object sender, EventArgs e)
        {
            ...
            if (PhotoFile.HasFile) //Verifica si se ha subido un archivo
            {
                ...
                int guardado = conexiones.ActualizarImagenSanVicente(id, texto, foto);
        ...
        protected void btnEliminar_Click(object sender, EventArgs e)
        {
            ...
            if (isNumber)
            {
                int eliminado = conexiones.EliminarRegistroSanVicente(id);
                if (eliminado == 1)
                {
