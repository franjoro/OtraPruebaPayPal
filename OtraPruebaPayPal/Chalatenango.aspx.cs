...
{
    public partial class Chalatenango : System.Web.UI.Page
    {
        ...
        {
            string[] datos = conexiones.ObtenerImagenesChalatenango();
        ...
        {
            Response.Redirect("AgregarImagenChalatenango.aspx");
        }

        protected void btnEditarImagen_Click(object sender, EventArgs e)
        {
            Response.Redirect("EditarImagenChalatenango.aspx");
        }
    }
}