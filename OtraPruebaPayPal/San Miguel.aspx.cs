...
{
    public partial class San_Miguel : System.Web.UI.Page
    {
        ...
        {
            string[] datos = conexiones.ObtenerImagenesSanMiguel();
        ...
        {
            Response.Redirect("AgregarImagenSanMiguel.aspx");
        }

        protected void btnEditarImagen_Click(object sender, EventArgs e)
        {
            Response.Redirect("EditarImagenSanMiguel.aspx");
        }
    }
}